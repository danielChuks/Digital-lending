      ...
      <div>
        <div className={styles["basic-info-container"]}>
         ...
         <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              label="Customer Type"
              onChange={(e) => handleSelector(e, "customerType")}
            ...
            <>
             <div className={styles["input-container-split"]}>
              <div>
                <CustomSelector
                  label="Title"
                  onChange={(e) => handleSelector(e, "titleCd")}
                  optionsList={picklistData.titleList}
                  name="titleCd"
                  value={CustomerData.basicInfoData.titleCd}
                  readonly={CustomerData.customerDraftReadOnlyFlag}
                />
                <span className="text-error">
                  {validator.message(
             ...
             <div className={styles["input-container-split"]}>
              <div className={styles["input-container"]}>
                <InputField
                  ...
                  type={"text"}
                  onChange={handleBasicInfo}
                  value={CustomerData.basicInfoData.firstName}
                  name="firstName"
                  readonly={CustomerData.customerDraftReadOnlyFlag}
                />
                <span className="text-error">
             ...
             <div className={styles["input-container-split"]}>
              <div className={styles["input-container"]}>
                <InputField
                  ...
                  type={"text"}
                  onChange={handleBasicInfo}
                  value={CustomerData.basicInfoData.middleName}
                  name="middleName"
                  readonly={CustomerData.customerDraftReadOnlyFlag}
                />
              </div>
             ...
             <div className={styles["input-container-split"]}>
              <div className={styles["input-container"]}>
                <InputField
                  ...
                  type={"text"}
                  onChange={handleBasicInfo}
                  value={CustomerData.basicInfoData.lastName}
                  name="lastName"
                  readonly={CustomerData.customerDraftReadOnlyFlag}
                />
                <span className="text-error">
          ...
          {!isIndividual ? (
            <>
             <div className={styles["input-container-split"]}>
              <div className={styles["input-container"]}>
                <InputField
                  ...
                  type={"text"}
                  onChange={handleBasicInfo}
                  value={CustomerData.basicInfoData.organisationName}
                ...
                <span className="text-error">
                  {!isIndividual
                    ? validator.message(
                        "organisationName",
                        CustomerData.basicInfoData.organisationName,
                        "required"
                      )
                    : ""}
                </span>
             ...
             <div className={styles["input-container-split"]}>
              <div className={styles["input-container"]}>
                <InputField
                  ...
                  type={"text"}
                  onChange={handleBasicInfo}
                  value={CustomerData.basicInfoData.registrationNumber}
             ...
             <div className={styles["input-container-split"]}>
              <div className={styles["input-container"]}>
              <CustomDatePicker
                  value={CustomerData.basicInfoData.strRegistrationDate}
                  ...
                  onChange={(date: any, dateString: any) => {
                    setCustomerData((prev) => ({
                      ...
                      basicInfoData: {
                        ...prev.basicInfoData,
                        strRegistrationDate: dateString,
                      },
                    }));
                  }}
                  readonly={CustomerData.customerDraftReadOnlyFlag}
        ...
        <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              label={"Nationality"}
              onChange={(e) => handleSelector(e, "nationalityCd")}
         ...
         <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              label={"Industry"}
              onChange={(e) => handleSelector(e, "industryId")}
         ...
         <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              ...
              onChange={(e) => handleSelector(e, "countryOfResidenceId")}
            ...
            <span className="text-error">
              {validator.message(
                ...
                CustomerData.basicInfoData.countryOfResidenceId,
                "required"
              )}
            </span>
          </div>
          ...
          {isIndividual ? (
             ...
             <div className={styles["input-container-split"]}>
                <div>
                  <CustomSelector
                    ...
                    onChange={(e) => handleSelector(e, "maritalStatus")}
                    optionsList={picklistData.maritalStatusList}
                    name="maritalStatus"
                    value={CustomerData.basicInfoData.maritalStatus}
                    readonly={CustomerData.customerDraftReadOnlyFlag}
                  />
                  <span className="text-error">
                    {validator.message(
                      "maritalStatus",
                      CustomerData.basicInfoData.maritalStatus,
                      "required"
                    )}
                  </span>
                </div>
            ...
            <div className={styles["input-container-split"]}>
                  <div className={styles["input-container"]}>
                    <InputField
                      ...
                      type={"text"}
                      onChange={handleBasicInfo}
                      value={CustomerData.basicInfoData.spouseName}
                      name="spouseName"
                      readonly={CustomerData.customerDraftReadOnlyFlag}
                    />
                  </div>
            ...
            <div className={styles["input-container-split"]}>
              <div className={styles["input-container"]}>
                <InputField
                  ...
                  type={"number"}
                  onChange={handleBasicInfo}
                  value={CustomerData.basicInfoData.nextOfKin}
                  name="nextOfKin"
                  readonly={CustomerData.customerDraftReadOnlyFlag}
                />
              </div>
            ...
            <div className={styles["input-container-split"]}>
              <div className={styles["input-container"]}>
                <InputField
                  ...
                  type={"number"}
                  onChange={handleBasicInfo}
                  value={CustomerData.basicInfoData.noOfDependents}
                  name="noOfDependents"
                  readonly={CustomerData.customerDraftReadOnlyFlag}
                />
              </div>
            ...
            <div className={styles["input-container-split"]}>
              <div>
                <CustomDatePicker
                  value={CustomerData.basicInfoData.strDateOfBirth}
                  label="Date of Birth"
                  onChange={(date: any, dateString: any) => {
                    setCustomerData((prev) => ({
                      ...prev,
                ...
                <span className="text-error">
                  {validator.message(
                    "noOfDependents",
                    CustomerData.basicInfoData.strDateOfBirth,
                    "required"
                  )}
                </span>
              </div>
           ...
           <div className={styles["input-container-split"]}>
              <div>
                <CustomSelector
                  ...
                  onChange={(e) => handleSelector(e, "countryOfBirthId")}
                  optionsList={picklistData.countryList}
                ...
                <span className="text-error">
                  {validator.message(
                    "countryOfBirthId",
                    CustomerData.basicInfoData.countryOfBirthId,
                    "required"
                  )}
         ...
         <div className={styles["input-container-split"]}>
              <div>
                <CustomSelector
                  label={"Gender"}
                  onChange={(e) => handleSelector(e, "gender")}
         ...
         <div className={styles["input-container-split"]}>
              <div>
                <CustomSelector
                  label={"Ocupation"}
                  onChange={(e) => handleSelector(e, "occupationCd")}
                  optionsList={picklistData.occupationList}
                  name="occupationCd"
                  value={CustomerData.basicInfoData.occupationCd}
                  readonly={CustomerData.customerDraftReadOnlyFlag}
                />
              </div>
         </div>
        ...
        {isIndividual ? (
          ...
          <div>
              <CustomRadioInput
                ...
                value={CustomerData.basicInfoData.employmentFlag}
                options={[
