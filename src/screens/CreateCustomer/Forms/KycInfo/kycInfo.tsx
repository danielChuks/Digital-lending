  ...
  useEffect(() => {
    if (props.identityData?.data) {
      setkycData({
        ...
        countryOfIssueId: (props.identityData.data.countryOfIssueId).toString(),
       ...
       <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              label={"Identity Type"}
              onChange={(e,option) => {
                handleSelector(e,option,"identityTypeDesc","identityTypeCd");
              }}
        ...
        <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              ...
              onChange={(e) => handleSelector(e,"","","countryOfIssueId")}
