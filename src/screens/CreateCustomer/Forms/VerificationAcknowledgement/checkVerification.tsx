    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                console.log(dataIdentification);
            }
            setLoading(false);
        } catch (error) {
            setLoading(false);
            ...
            <div className={styles["container"]}>
                ...
                <div className={styles["checkbox"]}>
                    <div className={styles["verification"]}>
                        <div>
                            <input type='checkbox' onClick={handleConsent} />
                        </div>
                        I consent to external Verification of my identity with
                        the identification provides as listed above
                    </div>

                    <div className={styles["proceed"]} onClick={handleProceed}>
