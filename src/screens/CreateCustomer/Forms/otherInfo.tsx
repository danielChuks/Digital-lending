      ...
      <div>
        ...
        <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              ...
              onChange={(e) => handleSelector(e, "openingReasonCd")}
              optionsList={picklistData.openingReasonList}
              value={CustomerData.otherInfoData.openingReasonCd}
              name={"OpeningReason"}
        ...
        <div className={styles["input-container-split"]}>
          ...
          <CustomSelector
            ...
            onChange={(e) => handleSelector(e, "marketingCampaignCd")}
            optionsList={picklistData.marketingCampaignList}
            value={CustomerData.otherInfoData.marketingCampaignCd}
          ...
          />
           <span className="text-error">
              {validator.message(
                "MarketingCampaign",
                CustomerData.otherInfoData.marketingCampaignCd,
                "required"
              )}
            </span>
          </div>
        ...
        <div className={styles["input-container-split"]}>
          <CustomSelector
            ...
            onChange={(e) => handleSelector(e, "sourceOfFundCd")}
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["input-container"]}>
            <InputField
              ...
              value={CustomerData.otherInfoData.monthlyIncomeAmount}
