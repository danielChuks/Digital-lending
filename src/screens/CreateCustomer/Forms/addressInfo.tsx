  ...
  (props, ref: any) => {
    ...
    const fetchStates = async () => {
      const payload = {
        ...
        subCategory: CustomerData.addressInfoData.primaryAddressCountryCd,
      };
      ...
      <div>
        ...
        <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              label={"Address Type"}
              onChange={(e) => handleSelector(e, "addressTypeId")}
              optionsList={picklistData.addressTypeList}
              value={CustomerData.addressInfoData.addressTypeId}
              name={"AddressType"}
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["input-container"]}>
            <InputField
              ...
              value={CustomerData.addressInfoData.primaryAddressLine1}
            ...
            <span className="text-error">
              {validator.message(
                "primaryAddressLine1",
                CustomerData.addressInfoData.primaryAddressLine1,
                "required"
              )}
            </span>
          </div>
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["input-container"]}>
            <InputField
              ...
              type={"text"}
              onChange={handleAddressInfo}
              value={CustomerData.addressInfoData.primaryAddressLine2}
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["input-container"]}>
            <InputField
              ...
              type={"text"}
              onChange={handleAddressInfo}
              value={CustomerData.addressInfoData.primaryAddressLine3}
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["input-container"]}>
            <InputField
              ...
              type={"text"}
              onChange={handleAddressInfo}
              value={CustomerData.addressInfoData.primaryAddressLine4}
        ...
        <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              label={"Country"}
              onChange={(e) => {
                handleSelector(e, "primaryAddressCountryCd");
                setCustomerData((prev) => ({
                  ...prev,
                  addressInfoData: {
        ...
        <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              ...
              optionsList={states}
              value={CustomerData.addressInfoData.primaryAddressState}
              name={"state"}
              readonly={CustomerData.customerDraftReadOnlyFlag}
            />
            <span className="text-error">
        ...
        <div className={styles["input-container-split"]}>
          <div>
            <CustomSelector
              label={"City"}
              onChange={(e) => handleSelector(e, "primaryAddressCity")}
              optionsList={cites}
              value={CustomerData.addressInfoData.primaryAddressCity}
              name={"city"}
              readonly={CustomerData.customerDraftReadOnlyFlag}
            />
            <span className="text-error">
              {validator.message(
                "city",
                CustomerData.addressInfoData.primaryAddressCity,
                "required"
              )}
            </span>
          </div>
