...
import IndividualIcon from "../../assets/icons/customerType/Individual.png";
  ...
  return (
    <div className={"main-container"}>
      ...
      <div className={styles["customer-type-action-container"]}>
        {actionIconsList.map(({ id, name, icon, path, customerType }) => (
          <div
            key={id}
            className={styles["action-box"]}
            onClick={() => {
              sessionStorage.setItem("custCat", customerType);
              navigate(path);
            }}
          >
