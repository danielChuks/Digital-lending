  ...
  return (
    <>
      ...
      <div className={"main-container"}>
        ...
        <div className={"main-heading"}>Account</div>
            ...
            {accountListData?.map(
              (
                ...
                >
                  ...
                  <div className={productCategory === "DP"?styles["account-action-content-dpAccount"]:styles["account-action-content-lnAccount"]}>
                    <div className={styles["text-container"]}>
                      <p>Account Number</p>
                      <b className={styles["green-text"]}>{acctNo}</b>
                    </div>
                    {productCategory === "DP" ? 
                      <div className={styles["text-container"]}>
                        <p>Account Balance</p>
                    ...
                    {productCategory === "LN" ? (
                      <>
                        ...
                        <div className={styles["text-container"]}>
                          <p>Due Amount</p>
                          <b className={styles["green-text"]}>{emi}</b>
                        </div>
                        <div className={styles["text-container"]}>
                          <p>Term</p>
                          <b className={styles["green-text"]}>{tenure}</b>
                        </div>
                        <div className={styles["text-container"]}>
                          <p>Next Instalment Amount</p>
                          <b className={styles["green-text"]}>
                            {nextInstalmentAmount}
                          </b>
                        </div>
                    ...
                    <div className={styles["text-container"]}>
                      <p>Account Type</p>
                      <b className={styles["green-text"]}>
                        {productCategory === "DP" ? "Deposit" : "Loan"}
                      </b>
                    </div>
                    <div className={styles["text-container"]}>
                      <p>Status</p>
                      <b className={styles["green-text"]}>{status}</b>
                    </div>
                  </div>
                </div>
              )
