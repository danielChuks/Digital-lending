  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (validator.allValid()) {
      if (pwd === confirmPwd) {
        ...
        setIsLoading(true);
        const response: any = await signUpMutation.mutateAsync(registerData);
  ...
  return (
    <>
      ...
      <div className={styles["main"]}>
        <div className={styles["register-header"]}>Create an Account</div>
        <form onSubmit={handleSubmit} className={styles["register-form"]}>
          <div className={styles["register-input-pair"]}>
            ...
            <div className={styles["confirmPwd"]}>
              ...
              />
              <span className="text-error">
                {validator.message("Repeat password", confirmPwd, "required")}
              </span>
            </div>
          </div>
