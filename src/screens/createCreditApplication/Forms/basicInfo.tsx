        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["validator-block"]}>
            ...
            <span className="text-error">
              {validator.message(
                "productId",
                creditApplDataFields_context.basicInfo?.productId,
                "required"
              )}
            </span>
          </div>
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["validator-block"]}>
            ...
            <span className="text-error">
              {validator.message(
                "currencyId",
                creditApplDataFields_context.basicInfo?.currencyId,
                "required"
              )}
            </span>
          </div>
          ...
          <div>
            <>
              <CustomDatePicker
                ...
                value={
                  creditApplDataFields_context.basicInfo?.strApplicationDate
                }
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["validator-block"]}>
            ...
            <span className="text-error">
              {validator.message(
                "termValue",
                creditApplDataFields_context.basicInfo?.termValue,
                "required"
              )}
            </span>
          </div>
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["validator-block"]}>
            <CustomSelector
              ...
              value={creditApplDataFields_context.basicInfo?.termCode}
              name={"termCode"}
              readonly={CustomerData.customerDraftReadOnlyFlag}
            />
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["validator-block"]}>
            <CustomSelector
              ...
              onChange={(e) => handleSelector(e, "repaySourceAcctNo")}
            ...
            <span className="text-error">
              {validator.message(
                "repaySourceAcctNo",
                creditApplDataFields_context.basicInfo?.repaySourceAcctNo,
                "required"
              )}
            </span>
          </div>
        ...
        <div className={styles["input-container-split"]}>
          <div className={styles["validator-block"]}>
            <CustomSelector
              ...
              onChange={(e) => handleSelector(e, "purposeOfCreditId")}
            ...
            <span className="text-error">
              {validator.message(
                "purposeOfCreditId",
                creditApplDataFields_context.basicInfo?.purposeOfCreditId,
                "required"
              )}
            </span>
          </div>
